...
bit like
```sh
go install -ldflags '-X main.Foo=bar' github.com/magisterquis/curlrevshell@betterctrli
```
...
" github.com/magisterquis/curlrevshell@betterctrli       # Install, setting defaults to $HOME/crs

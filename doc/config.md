...
bit like
```sh
go install -ldflags '-X main.Foo=bar' github.com/magisterquis/curlrevshell@latest
```
...
" github.com/magisterquis/curlrevshell@latest            # Install, setting defaults to $HOME/crs

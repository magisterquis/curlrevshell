...
For testing, `Ctrl+S` will print out what would be sent with `Ctrl+I`.
...
`-template`
-----------
Specifies a different template for the script generated by queries to `/c` as
well as the helpful one-liners printed when curlrevshell starts.  The
default is in
[`lib/crstemplate/default.tmpl`](../lib/crstemplate/default.tmpl)
